...
const projects: Project[] = [
  {
    ...
    description:
      "Luxury residential project featuring modern architecture and premium finishes. Currently under construction with completion expected soon.",
  ...
  },
  {
    ...
    location: "Bealey",
    description:
      "Contemporary bach with seamless indoor-outdoor flow. Design emphasizes natural light and connection with the surrounding landscape.",
    images: ["/images/54cloudesley1.jpg", "/images/54cloudesley2.jpg", "/images/house.png"],
  },
  {
    id: 3,
    ...
    location: "Bealey",
    description:
      "Elegant holiday home designed with sustainability and comfort in mind. Features spacious interiors and panoramic views.",
    images: ["/images/56cloudesley1.jpg", "/images/56cloudesley2.jpg", "/images/house.png"],
  },
];
    ...
    <section id='current-projects' className='py-24 bg-gray-50'>
      <div className='section-container'>
        <RevealAnimation className='max-w-3xl mx-auto text-center mb-16'>
          <span className='section-subtitle'>IN PROGRESS</span>
          <h2 className='section-title'>Current Projects</h2>
          <p className='text-muted-foreground text-lg'>
            Explore our ongoing construction projects currently being delivered by CVI Projects.
          </p>
        </RevealAnimation>
        ...
        <RevealAnimation className='grid grid-cols-1 lg:grid-cols-2 gap-12 items-center'>
          ...
          <div className='flex flex-col'>
            <h3 className='text-3xl font-bold text-primary mb-4'>{projects[activeProject].title}</h3>
            <div className='flex items-center gap-2 text-primary/80 mb-6'>
              <MapPin size={18} />
              <span>{projects[activeProject].location}</span>
            </div>
            <p className='text-muted-foreground text-lg mb-8'>{projects[activeProject].description}</p>
            <div className='flex flex-col gap-4'>
              ...
              <div className='flex items-center justify-between p-4 bg-primary/5 rounded-lg'>
                ...
                <span>{activeProject === 0 ? "Residential" : "Holiday Home"}</span>
              </div>
            </div>
          </div>
        </RevealAnimation>
